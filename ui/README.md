# kobh
  ...
  <img align="right" width="320" src="https://gitee.com/mydearzwj/image/raw/master/img/kobh.svg">


[![Build Status](https://github.com/wenjianzhang/kobh/workflows/build/badge.svg)](https://github.com/kobh-team/kobh)
[![Release](https://img.shields.io/github/release/kobh-team/kobh.svg?style=flat-square)](https://github.com/kobh-team/kobh/releases)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/kobh-team/kobh)

English | [简体中文](https://github.com/kobh-team/kobh/blob/master/README.Zh-cn.md)
...
[documentation](https://doc.kobh.dev)

[Backend project](https://github.com/kobh-team/kobh)
...
### Easily implement kobh to write the first application-documentation tutorial

[Step 1 - basic content introduction](http://doc.zhangwj.com/kobh-site/guide/intro/tutorial01.html)

[Step 2 - Practical application - writing database operations](http://doc.zhangwj.com/kobh-site/guide/intro/tutorial02.html)

### Teach you from getting started to giving up-video tutorial

[How to start kobh](https://www.bilibili.com/video/BV1z5411x7JG)
...
[Configuration instructions for kobh menu](https://www.bilibili.com/video/BV1Wp4y1D715) [Must see]

[How to configure menu information and interface information](https://www.bilibili.com/video/BV1zv411B7nG) [Must see]

[kobh permission configuration instructions](https://www.bilibili.com/video/BV1rt4y197d3) [Must see]

[Instructions for use of kobh data permissions](https://www.bilibili.com/video/BV1LK4y1s71e) [Must see]
...
```bash
# Get backend code
git clone https://github.com/kobh-team/kobh.git

# Get the front-end code
git clone https://github.com/kobh-team/kobh-ui.git
...
```bash
# Enter the kobh backend project
cd ./kobh
...
# Change setting 
# File path kobh/config/settings.yml
...
```bash
D:\Code\kobh>go build
# github.com/mattn/go-sqlite3
cgo: exec gcc: exec: "gcc": executable file not found in %PATH%
```

[Solve the cgo problem and enter](https://doc.kobh.dev/guide/other/faq.html#_5-cgo-exec-missing-cc-exec-missing-cc-file-does-not-exist)
...
$ ./kobh migrate -c=config/settings.dev.yml

# ⚠️Note: Use under windows
$ kobh.exe migrate -c=config/settings.dev.yml

# Start the project, you can also use the IDE for debugging
# Use under macOS or linux
$ ./kobh server -c config/settings.yml

# ⚠️Note: Use under windows
$ kobh.exe server -c config/settings.yml
```
...
# Start the container, the first kobh is the container name, and the second kobh is the image name
# -v Mapping configuration file Local path: container path
docker run --name kobh -p 8000:8000 -v /config/settings.yml:/config/settings.yml -d kobh-server
```
...
演示地址：[http://www.kobh.dev](http://www.kobh.dev/#/login)
...
<table>
  ...
  <tr>
    <td>Wechat</td>
    <td><a target="_blank" href="https://shang.qq.com/wpa/qunwpa?idkey=0f2bf59f5f2edec6a4550c364242c0641f870aa328e468c4ee4b7dbfb392627b"><img border="0" src="https://pub.idqqimg.com/wpa/images/group.png" alt="kobh技术交流乙号" title="kobh技术交流乙号"></a></td>
  </tr>
</table>
...
The `kobh` project has always been developed in the GoLand integrated development environment under JetBrains, based on the **free JetBrains Open Source license(s)** genuine free license. I would like to express my gratitude.
...
[MIT](https://github.com/kobh-team/kobh/blob/master/LICENSE.md)
